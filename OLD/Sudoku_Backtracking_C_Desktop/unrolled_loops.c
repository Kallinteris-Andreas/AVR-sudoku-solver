...
int exists_in_row(int row, int value){
  ...
  //  }
  //}
  if(grid[row][0] == value || grid[row][1] == value || grid[row][2] == value
...
int exists_in_column(int column, int value){
  ...
  if(grid[0][column] == value || grid[1][column] == value || grid[2][column] == value
...
if(grid[row_of_box][column_of_box] == value ||
