...
\subsubsection*{Using the interface program developed by Odysseas Stavrou -- TO BE EDITED}
...
TODO by elioudakis: Prepare this section and remove the previous one
...
\section*{Fuses configuration}
TODO by elioudakis: Maybe needed if the program should be downloaded to STK from another computer.

\section*{Conclusion - Future work --TODO: Should change}
