...
The fuses configuration of the development board is described in the file ``fuses\_config.conf''.

\section*{Conclusion}
No changes have been done to the code from milestone 1. **** ADD SOMETHING ****
